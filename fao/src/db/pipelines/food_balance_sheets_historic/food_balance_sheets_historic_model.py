...
class FoodBalanceSheetsHistoric(Base):
    __tablename__ = "food_balance_sheets_historic"
    ...
    def __repr__(self):
        ...
        return f"<FoodBalanceSheetsHistoric(id={self.id})>"
