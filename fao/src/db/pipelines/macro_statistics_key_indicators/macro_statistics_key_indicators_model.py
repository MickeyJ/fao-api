...
class MacroStatisticsKeyIndicators(Base):
    __tablename__ = "macro_statistics_key_indicators"
    ...
    def __repr__(self):
        ...
        return f"<MacroStatisticsKeyIndicators(id={self.id})>"
