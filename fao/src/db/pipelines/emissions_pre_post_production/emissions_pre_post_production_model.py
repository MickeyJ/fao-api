...
class EmissionsPrePostProduction(Base):
    __tablename__ = "emissions_pre_post_production"
    ...
    def __repr__(self):
        ...
        return f"<EmissionsPrePostProduction(id={self.id})>"
