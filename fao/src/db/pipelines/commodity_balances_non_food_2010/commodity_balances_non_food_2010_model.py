...
class CommodityBalancesNonFood2010(Base):
    __tablename__ = "commodity_balances_non_food_2010"
    ...
    def __repr__(self):
        ...
        return f"<CommodityBalancesNonFood2010(id={self.id})>"
