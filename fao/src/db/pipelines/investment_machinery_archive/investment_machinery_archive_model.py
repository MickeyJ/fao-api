...
class InvestmentMachineryArchive(Base):
    __tablename__ = "investment_machinery_archive"
    ...
    def __repr__(self):
        ...
        return f"<InvestmentMachineryArchive(id={self.id})>"
