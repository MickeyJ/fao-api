...
class TradeCropsLivestockIndicators(Base):
    __tablename__ = "trade_crops_livestock_indicators"
    ...
    #     #         #         #             #         #             #         #             #         #             #         #         #             #         #         #         #         #             #             
    #         # __table_args__ = (
    #     Index("ix_9f53bd85_uniq_uniq", 
    #         'area_code_id', 'item_code_id', 'indicator_code_id', 'flag_id', 'year', 'unit',
    #         unique=True),
    # )
    #         
    def __repr__(self):
        # Show first few columns for datasets
        return f"<TradeCropsLivestockIndicators(id={self.id})>"
