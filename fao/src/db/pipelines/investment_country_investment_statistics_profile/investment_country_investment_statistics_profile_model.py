...
class InvestmentCountryInvestmentStatisticsProfile(Base):
    __tablename__ = "investment_country_investment_statistics_profile"
    ...
    def __repr__(self):
        ...
        return f"<InvestmentCountryInvestmentStatisticsProfile(id={self.id})>"
