...
class EnvironmentEmissionsIntensities(Base):
    __tablename__ = "environment_emissions_intensities"
    ...
    def __repr__(self):
        ...
        return f"<EnvironmentEmissionsIntensities(id={self.id})>"
