...
class InvestmentForeignDirectInvestment(Base):
    __tablename__ = "investment_foreign_direct_investment"
    ...
    def __repr__(self):
        ...
        return f"<InvestmentForeignDirectInvestment(id={self.id})>"
