...
class InvestmentGovernmentExpenditure(Base):
    __tablename__ = "investment_government_expenditure"
    ...
    def __repr__(self):
        ...
        return f"<InvestmentGovernmentExpenditure(id={self.id})>"
