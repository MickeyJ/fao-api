...
class InvestmentCreditAgriculture(Base):
    __tablename__ = "investment_credit_agriculture"
    ...
    def __repr__(self):
        ...
        return f"<InvestmentCreditAgriculture(id={self.id})>"
