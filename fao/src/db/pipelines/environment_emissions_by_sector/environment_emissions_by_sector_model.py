...
class EnvironmentEmissionsBySector(Base):
    __tablename__ = "environment_emissions_by_sector"
    ...
    def __repr__(self):
        ...
        return f"<EnvironmentEmissionsBySector(id={self.id})>"
