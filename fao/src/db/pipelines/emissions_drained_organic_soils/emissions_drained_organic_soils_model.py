...
class EmissionsDrainedOrganicSoils(Base):
    __tablename__ = "emissions_drained_organic_soils"
    ...
    def __repr__(self):
        ...
        return f"<EmissionsDrainedOrganicSoils(id={self.id})>"
