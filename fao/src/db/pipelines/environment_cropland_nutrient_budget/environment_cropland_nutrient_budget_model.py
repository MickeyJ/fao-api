...
class EnvironmentCroplandNutrientBudget(Base):
    __tablename__ = "environment_cropland_nutrient_budget"
    ...
    def __repr__(self):
        ...
        return f"<EnvironmentCroplandNutrientBudget(id={self.id})>"
