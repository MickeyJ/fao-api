...
class EnvironmentLivestockPatterns(Base):
    __tablename__ = "environment_livestock_patterns"
    ...
    def __repr__(self):
        ...
        return f"<EnvironmentLivestockPatterns(id={self.id})>"
