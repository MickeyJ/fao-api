...
from .commodity_balances_non_food_2013_old_methodology.__main__ import (
    run_all as run_commodity_balances_non_food_2013_old_methodology,
)
...
from .food_and_diet_individual_quantitative_dietary_data.__main__ import (
    run_all as run_food_and_diet_individual_quantitative_dietary_data,
)
...
from .household_consumption_and_expenditure_surveys_food_and_diet.__main__ import (
    run_all as run_household_consumption_and_expenditure_surveys_food_and_diet,
)
from .indicators_from_household_surveys.__main__ import run_all as run_indicators_from_household_surveys
from .individual_quantitative_dietary_data_food_and_diet.__main__ import (
    run_all as run_individual_quantitative_dietary_data_food_and_diet,
)
...
from .investment_country_investment_statistics_profile.__main__ import (
    run_all as run_investment_country_investment_statistics_profile,
)
...
from .minimum_dietary_diversity_for_women_mdd_w_food_and_diet.__main__ import (
    run_all as run_minimum_dietary_diversity_for_women_mdd_w_food_and_diet,
)
...
def run_all_pipelines(db):
    ...
    # run_emissions_crops(db) # TODO - DELETE DUPES!
