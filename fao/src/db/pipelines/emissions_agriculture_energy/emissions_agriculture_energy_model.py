...
class EmissionsAgricultureEnergy(Base):
    __tablename__ = "emissions_agriculture_energy"
    ...
    def __repr__(self):
        ...
        return f"<EmissionsAgricultureEnergy(id={self.id})>"
