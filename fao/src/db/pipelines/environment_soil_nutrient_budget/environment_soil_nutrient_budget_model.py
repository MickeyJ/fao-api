...
class EnvironmentSoilNutrientBudget(Base):
    __tablename__ = "environment_soil_nutrient_budget"
    ...
    def __repr__(self):
        ...
        return f"<EnvironmentSoilNutrientBudget(id={self.id})>"
