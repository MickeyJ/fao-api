...
class EnvironmentFoodWasteDisposal(Base):
    __tablename__ = "environment_food_waste_disposal"
    ...
    def __repr__(self):
        ...
        return f"<EnvironmentFoodWasteDisposal(id={self.id})>"
