...
class PartnerCountryCodes(Base):
    __tablename__ = "partner_country_codes"
    ...
    __table_args__ = (
        Index("ix_partner__partner__src", 'partner_country_code', 'source_dataset', unique=True),
    )
    # TODO: Indices for dataset tables
    #     
    def __repr__(self):
        return f"<PartnerCountryCodes(partner_country_code={self.partner_country_code})>"
