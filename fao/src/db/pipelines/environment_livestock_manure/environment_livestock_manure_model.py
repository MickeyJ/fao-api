...
class EnvironmentLivestockManure(Base):
    __tablename__ = "environment_livestock_manure"
    ...
    def __repr__(self):
        ...
        return f"<EnvironmentLivestockManure(id={self.id})>"
