...
class CostAffordabilityHealthyDietCoAhd(Base):
    __tablename__ = "cost_affordability_healthy_diet_co_ahd"
    ...
    release_code_id = Column(Integer, ForeignKey("releases.id"), index=True)
    ...
    #     #         #         #             #         #             #         #             #         #             #         #             #         #         #             #         #         #         #         #             #             
    #         # __table_args__ = (
    #     Index("ix_4452b1a3_uniq_uniq", 
    #         'area_code_id', 'item_code_id', 'element_code_id', 'release_code_id', 'flag_id', 'year', 'unit',
    #         unique=True),
    # )
    #         
    def __repr__(self):
        # Show first few columns for datasets
        return f"<CostAffordabilityHealthyDietCoAhd(id={self.id})>"
