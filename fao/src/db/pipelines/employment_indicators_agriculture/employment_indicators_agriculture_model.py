...
class EmploymentIndicatorsAgriculture(Base):
    __tablename__ = "employment_indicators_agriculture"
    ...
    def __repr__(self):
        ...
        return f"<EmploymentIndicatorsAgriculture(id={self.id})>"
