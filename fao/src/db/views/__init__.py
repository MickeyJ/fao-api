...
PRICE_RATIOS_USD_VIEW = PGMaterializedView(
    ...
    definition=price_ratios_usd_sql,
    with_data=True,
)
...
PRICE_RATIOS_LCU_VIEW = PGMaterializedView(
    ...
    definition=price_ratios_lcu_sql,
    with_data=True,
)
...
PRICE_DETAILS_USD_VIEW = PGMaterializedView(
    ...
    definition=price_details_usd_sql,
    with_data=True,
)
...
PRICE_DETAILS_LCU_VIEW = PGMaterializedView(
    ...
    definition=price_details_lcu_sql,
    with_data=True,
)
