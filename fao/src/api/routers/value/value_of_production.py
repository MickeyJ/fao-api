...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in value_of_production")
...
@router.get("/item_codes", summary="Get ItemCodes in value_of_production")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(ValueOfProduction, Elements.id == ValueOfProduction.element_id)
            .where(Elements.source_dataset == 'value_of_production')
            .group_by(
                Elements.element_code,
                Elements.element,
