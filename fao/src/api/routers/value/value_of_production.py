...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ValueOfProduction, AreaCodes.id == ValueOfProduction.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ValueOfProduction, ItemCodes.id == ValueOfProduction.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ValueOfProduction, Elements.id == ValueOfProduction.element_code_id)
