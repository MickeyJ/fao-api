...
# Generated as: fao/src/api/routers/value_of_production_config.py
...
@dataclass
class ValueOfProductionConfig:
    """Configuration for value_of_production API"""
    
    # Basic info
    name: str = "value_of_production"
    model_name: str = "ValueOfProduction"
    table_name: str = "value_of_production"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": ValueOfProduction.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ValueOfProduction.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ValueOfProduction.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ValueOfProduction.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": ValueOfProduction,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": ValueOfProduction,
            "filter_column": "year",
        },
        {
            "param_name": "value",
