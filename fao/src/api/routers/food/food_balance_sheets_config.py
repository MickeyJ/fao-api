...
# Generated as: fao/src/api/routers/food_balance_sheets_config.py
...
@dataclass
class FoodBalanceSheetsConfig:
    """Configuration for food_balance_sheets API"""
    
    # Basic info
    name: str = "food_balance_sheets"
    model_name: str = "FoodBalanceSheets"
    table_name: str = "food_balance_sheets"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": FoodBalanceSheets.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": FoodBalanceSheets.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": FoodBalanceSheets.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": FoodBalanceSheets.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": FoodBalanceSheets,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": FoodBalanceSheets,
            "filter_column": "year",
        },
        {
            "param_name": "value",
