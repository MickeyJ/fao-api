...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(FoodBalanceSheetsHistoric, AreaCodes.id == FoodBalanceSheetsHistoric.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(FoodBalanceSheetsHistoric, ItemCodes.id == FoodBalanceSheetsHistoric.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(FoodBalanceSheetsHistoric, Elements.id == FoodBalanceSheetsHistoric.element_code_id)
