...
def get_food_balance_sheets_historic(
    ...
    """
    food balance sheets historic data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, FoodBalanceSheetsHistoric.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, FoodBalanceSheetsHistoric.item_code_id == ItemCodes.id)
        .outerjoin(Elements, FoodBalanceSheetsHistoric.element_code_id == Elements.id)
        .outerjoin(Flags, FoodBalanceSheetsHistoric.flag_id == Flags.id)
    )
