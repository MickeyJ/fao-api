...
# Generated as: fao/src/api/routers/food_security_data_config.py
...
@dataclass
class FoodSecurityDataConfig:
    """Configuration for food_security_data API"""
    
    # Basic info
    name: str = "food_security_data"
    model_name: str = "FoodSecurityData"
    table_name: str = "food_security_data"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": FoodSecurityData.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": FoodSecurityData.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": FoodSecurityData.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": FoodSecurityData.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": FoodSecurityData,  # <-- Actual model class
