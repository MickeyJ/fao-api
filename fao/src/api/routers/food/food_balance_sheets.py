...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(FoodBalanceSheets, AreaCodes.id == FoodBalanceSheets.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(FoodBalanceSheets, ItemCodes.id == FoodBalanceSheets.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(FoodBalanceSheets, Elements.id == FoodBalanceSheets.element_code_id)
