...
def get_food_balance_sheets(
    ...
    """
    food balance sheets data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, FoodBalanceSheets.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, FoodBalanceSheets.item_code_id == ItemCodes.id)
        .outerjoin(Elements, FoodBalanceSheets.element_code_id == Elements.id)
        .outerjoin(Flags, FoodBalanceSheets.flag_id == Flags.id)
    )
