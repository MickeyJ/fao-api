...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in food_balance_sheets")
...
@router.get("/item_codes", summary="Get ItemCodes in food_balance_sheets")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(FoodBalanceSheets, Elements.id == FoodBalanceSheets.element_id)
            .where(Elements.source_dataset == 'food_balance_sheets')
            .group_by(
                Elements.element_code,
                Elements.element,
