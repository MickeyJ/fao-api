...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in food_security_data")
...
@router.get("/item_codes", summary="Get ItemCodes in food_security_data")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(FoodSecurityData, Elements.id == FoodSecurityData.element_id)
            .where(Elements.source_dataset == 'food_security_data')
            .group_by(
                Elements.element_code,
                Elements.element,
