...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/recipient_country_codes", summary="Get RecipientCountryCodes in food_aid_shipments_wfp")
    ...
    if include_distribution:
        query = (
            ...
            .join(FoodAidShipmentsWfp, 
                FoodAidShipmentsWfp.recipient_country_code_id == RecipientCountryCodes.id)
            .where(RecipientCountryCodes.source_dataset == 'food_aid_shipments_wfp')
        )
...
@router.get("/item_codes", summary="Get ItemCodes in food_aid_shipments_wfp")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(FoodAidShipmentsWfp, Elements.id == FoodAidShipmentsWfp.element_id)
            .where(Elements.source_dataset == 'food_aid_shipments_wfp')
            .group_by(
                Elements.element_code,
                Elements.element,
