...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in commodity_balances_non_food_2010")
...
@router.get("/item_codes", summary="Get ItemCodes in commodity_balances_non_food_2010")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(CommodityBalancesNonFood2010, Elements.id == CommodityBalancesNonFood2010.element_id)
            .where(Elements.source_dataset == 'commodity_balances_non_food_2010')
            .group_by(
                Elements.element_code,
                Elements.element,
