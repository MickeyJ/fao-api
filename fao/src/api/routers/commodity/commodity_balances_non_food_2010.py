...
def get_commodity_balances_non_food_2010(
    ...
    """
    commodity balances non food 2010 data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, CommodityBalancesNonFood2010.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, CommodityBalancesNonFood2010.item_code_id == ItemCodes.id)
        .outerjoin(Elements, CommodityBalancesNonFood2010.element_code_id == Elements.id)
        .outerjoin(Flags, CommodityBalancesNonFood2010.flag_id == Flags.id)
    )
