...
# Generated as: fao/src/api/routers/commodity_balances_non_food_2013_old_methodology_config.py
...
@dataclass
class CommodityBalancesNonFood2013OldMethodologyConfig:
    """Configuration for commodity_balances_non_food_2013_old_methodology API"""
    
    # Basic info
    name: str = "commodity_balances_non_food_2013_old_methodology"
    model_name: str = "CommodityBalancesNonFood2013OldMethodology"
    table_name: str = "commodity_balances_non_food_2013_old_methodology"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": CommodityBalancesNonFood2013OldMethodology.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CommodityBalancesNonFood2013OldMethodology.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CommodityBalancesNonFood2013OldMethodology.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CommodityBalancesNonFood2013OldMethodology.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": CommodityBalancesNonFood2013OldMethodology,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": CommodityBalancesNonFood2013OldMethodology,
            "filter_column": "year",
        },
        {
            "param_name": "value",
