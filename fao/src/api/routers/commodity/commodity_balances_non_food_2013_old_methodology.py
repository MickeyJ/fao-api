...
@router.get("/")
@cache_result(prefix="commodity_balances_non_food_2013_old_methodology", ttl=86400, exclude_params=["response", "db"])
def get_commodity_balances_non_food_2013_old_methodology(
    response: Response,
    ...
    """
    Get commodity balances non food 2013 old methodology data with filters and pagination.
    ...
    # Main table columns
    for col in CommodityBalancesNonFood2013OldMethodology.__table__.columns:
    ...
    if requested_fields:
        ...
        for field_name in requested_fields:
            ...
            elif field_name == 'id' and hasattr(CommodityBalancesNonFood2013OldMethodology, 'id'):
                columns.append(CommodityBalancesNonFood2013OldMethodology.id)
    else:
    ...
    # Build base query
    query = select(*columns).select_from(CommodityBalancesNonFood2013OldMethodology)
    
    # Add joins
    query = query.outerjoin(AreaCodes, CommodityBalancesNonFood2013OldMethodology.area_code_id == AreaCodes.id)
    query = query.outerjoin(ItemCodes, CommodityBalancesNonFood2013OldMethodology.item_code_id == ItemCodes.id)
    query = query.outerjoin(Elements, CommodityBalancesNonFood2013OldMethodology.element_code_id == Elements.id)
    query = query.outerjoin(Flags, CommodityBalancesNonFood2013OldMethodology.flag_id == Flags.id)
    ...
    if year_code is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.year_code.ilike("%" + year_code + "%"))
    if year_code_exact is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.year_code == year_code_exact)
    if year is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.year == year)
    if year_min is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.year >= year_min)
    if year_max is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.year <= year_max)
    if unit is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.unit.ilike("%" + unit + "%"))
    if unit_exact is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.unit == unit_exact)
    if value is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.value == value)
    if value_min is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.value >= value_min)
    if value_max is not None:
        conditions.append(CommodityBalancesNonFood2013OldMethodology.value <= value_max)
        ...
        for sort_field in sort.split(','):
            ...
            if sort_field:  # Skip empty strings
                if sort_field.startswith('-'):
                    ...
                    if hasattr(CommodityBalancesNonFood2013OldMethodology, field_name):
                        order_by_clauses.append(getattr(CommodityBalancesNonFood2013OldMethodology, field_name).desc())
                else:
                    # Ascending order
                    if hasattr(CommodityBalancesNonFood2013OldMethodology, sort_field):
                        order_by_clauses.append(getattr(CommodityBalancesNonFood2013OldMethodology, sort_field))
        
        if order_by_clauses:
            query = query.order_by(*order_by_clauses)
    else:
        # Default ordering by ID for consistent pagination
        query = query.order_by(CommodityBalancesNonFood2013OldMethodology.id)
    
    # Get total count with filters applied
    count_query = select(func.count()).select_from(CommodityBalancesNonFood2013OldMethodology)
    
    # Add joins to count query
    count_query = count_query.outerjoin(AreaCodes, CommodityBalancesNonFood2013OldMethodology.area_code_id == AreaCodes.id)
    count_query = count_query.outerjoin(ItemCodes, CommodityBalancesNonFood2013OldMethodology.item_code_id == ItemCodes.id)
    count_query = count_query.outerjoin(Elements, CommodityBalancesNonFood2013OldMethodology.element_code_id == Elements.id)
    count_query = count_query.outerjoin(Flags, CommodityBalancesNonFood2013OldMethodology.flag_id == Flags.id)
    ...
    base_url = str(router.url_path_for('get_commodity_balances_non_food_2013_old_methodology'))
...
@router.get("/areas")
@cache_result(prefix="commodity_balances_non_food_2013_old_methodology:areas", ttl=604800)
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(CommodityBalancesNonFood2013OldMethodology, AreaCodes.id == CommodityBalancesNonFood2013OldMethodology.area_code_id)
...
@router.get("/items")
@cache_result(prefix="commodity_balances_non_food_2013_old_methodology:items", ttl=604800)
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(CommodityBalancesNonFood2013OldMethodology, ItemCodes.id == CommodityBalancesNonFood2013OldMethodology.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(CommodityBalancesNonFood2013OldMethodology, Elements.id == CommodityBalancesNonFood2013OldMethodology.element_code_id)
...
def get_temporal_coverage(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .group_by(CommodityBalancesNonFood2013OldMethodology.year)
    ...
    if not years_data:
        return {"dataset": "commodity_balances_non_food_2013_old_methodology", "message": "No temporal data available"}
...
@router.get("/summary")
@cache_result(prefix="commodity_balances_non_food_2013_old_methodology:summary", ttl=604800)
def get_dataset_summary(db: Session = Depends(get_db)):
    """Get comprehensive summary of this dataset"""
    total_records = db.query(func.count(CommodityBalancesNonFood2013OldMethodology.id)).scalar()
    ...
    summary["unique_areas"] = db.query(func.count(func.distinct(CommodityBalancesNonFood2013OldMethodology.area_code_id))).scalar()
    summary["unique_items"] = db.query(func.count(func.distinct(CommodityBalancesNonFood2013OldMethodology.item_code_id))).scalar()
    summary["unique_elements"] = db.query(func.count(func.distinct(CommodityBalancesNonFood2013OldMethodology.element_code_id))).scalar()
