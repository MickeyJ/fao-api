...
def get_commodity_balances_non_food_2013_old_methodology(
    ...
    """
    commodity balances non food 2013 old methodology data with filters.
    Filter options:
    ...
    query = (
        select(
            CommodityBalancesNonFood2013OldMethodology,
        ...
        .outerjoin(AreaCodes, CommodityBalancesNonFood2013OldMethodology.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, CommodityBalancesNonFood2013OldMethodology.item_code_id == ItemCodes.id)
        .outerjoin(Elements, CommodityBalancesNonFood2013OldMethodology.element_code_id == Elements.id)
        .outerjoin(Flags, CommodityBalancesNonFood2013OldMethodology.flag_id == Flags.id)
    )
