...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in commodity_balances_non_food_2013_old_methodology")
...
@router.get("/item_codes", summary="Get ItemCodes in commodity_balances_non_food_2013_old_methodology")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(CommodityBalancesNonFood2013OldMethodology, Elements.id == CommodityBalancesNonFood2013OldMethodology.element_id)
            .where(Elements.source_dataset == 'commodity_balances_non_food_2013_old_methodology')
            .group_by(
                Elements.element_code,
                Elements.element,
