...
# Generated as: fao/src/api/routers/commodity_balances_non_food_2010_config.py
...
@dataclass
class CommodityBalancesNonFood2010Config:
    """Configuration for commodity_balances_non_food_2010 API"""
    
    # Basic info
    name: str = "commodity_balances_non_food_2010"
    model_name: str = "CommodityBalancesNonFood2010"
    table_name: str = "commodity_balances_non_food_2010"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": CommodityBalancesNonFood2010.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CommodityBalancesNonFood2010.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CommodityBalancesNonFood2010.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CommodityBalancesNonFood2010.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": CommodityBalancesNonFood2010,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": CommodityBalancesNonFood2010,
            "filter_column": "year",
        },
        {
            "param_name": "value",
