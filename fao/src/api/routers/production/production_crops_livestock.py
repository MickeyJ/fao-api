...
def get_production_crops_livestock(
    ...
    """
    production crops livestock data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, ProductionCropsLivestock.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, ProductionCropsLivestock.item_code_id == ItemCodes.id)
        .outerjoin(Elements, ProductionCropsLivestock.element_code_id == Elements.id)
        .outerjoin(Flags, ProductionCropsLivestock.flag_id == Flags.id)
    )
