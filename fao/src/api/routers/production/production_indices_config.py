...
# Generated as: fao/src/api/routers/production_indices_config.py
...
@dataclass
class ProductionIndicesConfig:
    """Configuration for production_indices API"""
    
    # Basic info
    name: str = "production_indices"
    model_name: str = "ProductionIndices"
    table_name: str = "production_indices"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": ProductionIndices.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ProductionIndices.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ProductionIndices.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ProductionIndices.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": ProductionIndices,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": ProductionIndices,
            "filter_column": "year",
        },
        {
            "param_name": "value",
