...
def get_production_indices(
    ...
    """
    production indices data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, ProductionIndices.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, ProductionIndices.item_code_id == ItemCodes.id)
        .outerjoin(Elements, ProductionIndices.element_code_id == Elements.id)
        .outerjoin(Flags, ProductionIndices.flag_id == Flags.id)
    )
