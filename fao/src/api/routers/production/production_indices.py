...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ProductionIndices, AreaCodes.id == ProductionIndices.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ProductionIndices, ItemCodes.id == ProductionIndices.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ProductionIndices, Elements.id == ProductionIndices.element_code_id)
