...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in production_indices")
...
@router.get("/item_codes", summary="Get ItemCodes in production_indices")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(ProductionIndices, Elements.id == ProductionIndices.element_id)
            .where(Elements.source_dataset == 'production_indices')
            .group_by(
                Elements.element_code,
                Elements.element,
