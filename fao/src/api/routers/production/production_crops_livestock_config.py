...
# Generated as: fao/src/api/routers/production_crops_livestock_config.py
...
@dataclass
class ProductionCropsLivestockConfig:
    """Configuration for production_crops_livestock API"""
    
    # Basic info
    name: str = "production_crops_livestock"
    model_name: str = "ProductionCropsLivestock"
    table_name: str = "production_crops_livestock"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": ProductionCropsLivestock.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ProductionCropsLivestock.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ProductionCropsLivestock.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ProductionCropsLivestock.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": ProductionCropsLivestock,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": ProductionCropsLivestock,
            "filter_column": "year",
        },
        {
            "param_name": "value",
