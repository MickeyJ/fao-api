...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in asti_researchers")
...
@router.get("/item_codes", summary="Get ItemCodes in asti_researchers")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(AstiResearchers, Elements.id == AstiResearchers.element_id)
            .where(Elements.source_dataset == 'asti_researchers')
            .group_by(
                Elements.element_code,
                Elements.element,
