...
def get_asti_researchers(
    ...
    """
    asti researchers data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, AstiResearchers.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, AstiResearchers.item_code_id == ItemCodes.id)
        .outerjoin(Elements, AstiResearchers.element_code_id == Elements.id)
        .outerjoin(Flags, AstiResearchers.flag_id == Flags.id)
    )
