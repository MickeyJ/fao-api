...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(AstiResearchers, AreaCodes.id == AstiResearchers.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(AstiResearchers, ItemCodes.id == AstiResearchers.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(AstiResearchers, Elements.id == AstiResearchers.element_code_id)
