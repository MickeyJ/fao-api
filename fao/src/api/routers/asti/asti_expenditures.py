...
def get_asti_expenditures(
    ...
    """
    asti expenditures data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, AstiExpenditures.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, AstiExpenditures.item_code_id == ItemCodes.id)
        .outerjoin(Elements, AstiExpenditures.element_code_id == Elements.id)
        .outerjoin(Flags, AstiExpenditures.flag_id == Flags.id)
    )
