...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in asti_expenditures")
...
@router.get("/item_codes", summary="Get ItemCodes in asti_expenditures")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(AstiExpenditures, Elements.id == AstiExpenditures.element_id)
            .where(Elements.source_dataset == 'asti_expenditures')
            .group_by(
                Elements.element_code,
                Elements.element,
