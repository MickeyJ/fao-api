...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(AstiExpenditures, AreaCodes.id == AstiExpenditures.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(AstiExpenditures, ItemCodes.id == AstiExpenditures.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(AstiExpenditures, Elements.id == AstiExpenditures.element_code_id)
