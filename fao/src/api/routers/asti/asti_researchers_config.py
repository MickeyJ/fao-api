...
# Generated as: fao/src/api/routers/asti_researchers_config.py
...
@dataclass
class AstiResearchersConfig:
    """Configuration for asti_researchers API"""
    
    # Basic info
    name: str = "asti_researchers"
    model_name: str = "AstiResearchers"
    table_name: str = "asti_researchers"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": AstiResearchers.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": AstiResearchers.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": AstiResearchers.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": AstiResearchers.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": AstiResearchers,  # <-- Actual model class
