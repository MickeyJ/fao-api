...
# Generated as: fao/src/api/routers/forestry_pulp_paper_survey_config.py
...
@dataclass
class ForestryPulpPaperSurveyConfig:
    """Configuration for forestry_pulp_paper_survey API"""
    
    # Basic info
    name: str = "forestry_pulp_paper_survey"
    model_name: str = "ForestryPulpPaperSurvey"
    table_name: str = "forestry_pulp_paper_survey"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": ForestryPulpPaperSurvey.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ForestryPulpPaperSurvey.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ForestryPulpPaperSurvey.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ForestryPulpPaperSurvey.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": ForestryPulpPaperSurvey,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": ForestryPulpPaperSurvey,
            "filter_column": "year",
        },
        {
            "param_name": "value",
