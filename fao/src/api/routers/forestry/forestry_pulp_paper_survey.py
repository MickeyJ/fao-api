...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in forestry_pulp_paper_survey")
...
@router.get("/item_codes", summary="Get ItemCodes in forestry_pulp_paper_survey")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(ForestryPulpPaperSurvey, Elements.id == ForestryPulpPaperSurvey.element_id)
            .where(Elements.source_dataset == 'forestry_pulp_paper_survey')
            .group_by(
                Elements.element_code,
                Elements.element,
