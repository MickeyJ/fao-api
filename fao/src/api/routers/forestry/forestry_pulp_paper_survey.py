...
def get_forestry_pulp_paper_survey(
    ...
    """
    forestry pulp paper survey data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, ForestryPulpPaperSurvey.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, ForestryPulpPaperSurvey.item_code_id == ItemCodes.id)
        .outerjoin(Elements, ForestryPulpPaperSurvey.element_code_id == Elements.id)
        .outerjoin(Flags, ForestryPulpPaperSurvey.flag_id == Flags.id)
    )
