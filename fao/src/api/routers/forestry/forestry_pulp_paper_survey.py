...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ForestryPulpPaperSurvey, AreaCodes.id == ForestryPulpPaperSurvey.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ForestryPulpPaperSurvey, ItemCodes.id == ForestryPulpPaperSurvey.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ForestryPulpPaperSurvey, Elements.id == ForestryPulpPaperSurvey.element_code_id)
