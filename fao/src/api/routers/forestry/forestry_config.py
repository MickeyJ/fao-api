...
# Generated as: fao/src/api/routers/forestry_config.py
...
class ForestryConfig:
    """Configuration for forestry API"""
    
    # Basic info
    name: str = "forestry"
    model_name: str = "Forestry"
    table_name: str = "forestry"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": Forestry.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Forestry.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Forestry.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Forestry.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": Forestry,  # <-- Actual model class
