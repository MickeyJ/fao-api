...
def get_forestry(
    ...
    query = (
        ...
        .outerjoin(AreaCodes, Forestry.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, Forestry.item_code_id == ItemCodes.id)
        .outerjoin(Elements, Forestry.element_code_id == Elements.id)
        .outerjoin(Flags, Forestry.flag_id == Flags.id)
    )
