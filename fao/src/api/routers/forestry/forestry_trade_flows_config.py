...
# Generated as: fao/src/api/routers/forestry_trade_flows_config.py
...
@dataclass
class ForestryTradeFlowsConfig:
    """Configuration for forestry_trade_flows API"""
    
    # Basic info
    name: str = "forestry_trade_flows"
    model_name: str = "ForestryTradeFlows"
    table_name: str = "forestry_trade_flows"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": ForestryTradeFlows.reporter_country_code_id,
        },
        {
        ...
        },
        {
            ...
            "join_condition": ForestryTradeFlows.partner_country_code_id,
        },
        {
        ...
        },
        {
            ...
            "join_condition": ForestryTradeFlows.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ForestryTradeFlows.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ForestryTradeFlows.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": ForestryTradeFlows,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": ForestryTradeFlows,
            "filter_column": "year",
        },
        {
            "param_name": "value",
