...
# Generated as: fao/src/api/routers/investment_machinery_archive_config.py
...
@dataclass
class InvestmentMachineryArchiveConfig:
    """Configuration for investment_machinery_archive API"""
    
    # Basic info
    name: str = "investment_machinery_archive"
    model_name: str = "InvestmentMachineryArchive"
    table_name: str = "investment_machinery_archive"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InvestmentMachineryArchive.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentMachineryArchive.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentMachineryArchive.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentMachineryArchive.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InvestmentMachineryArchive,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InvestmentMachineryArchive,
            "filter_column": "year",
        },
        {
            "param_name": "value",
