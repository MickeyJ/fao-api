...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in investment_machinery")
...
@router.get("/item_codes", summary="Get ItemCodes in investment_machinery")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InvestmentMachinery, Elements.id == InvestmentMachinery.element_id)
            .where(Elements.source_dataset == 'investment_machinery')
            .group_by(
                Elements.element_code,
                Elements.element,
