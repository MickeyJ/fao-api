...
def get_investment_machinery(
    ...
    """
    investment machinery data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, InvestmentMachinery.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InvestmentMachinery.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InvestmentMachinery.element_code_id == Elements.id)
        .outerjoin(Flags, InvestmentMachinery.flag_id == Flags.id)
    )
