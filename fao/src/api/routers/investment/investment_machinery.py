...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentMachinery, AreaCodes.id == InvestmentMachinery.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentMachinery, ItemCodes.id == InvestmentMachinery.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentMachinery, Elements.id == InvestmentMachinery.element_code_id)
