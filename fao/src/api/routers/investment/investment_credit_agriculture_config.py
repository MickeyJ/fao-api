...
# Generated as: fao/src/api/routers/investment_credit_agriculture_config.py
...
@dataclass
class InvestmentCreditAgricultureConfig:
    """Configuration for investment_credit_agriculture API"""
    
    # Basic info
    name: str = "investment_credit_agriculture"
    model_name: str = "InvestmentCreditAgriculture"
    table_name: str = "investment_credit_agriculture"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InvestmentCreditAgriculture.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCreditAgriculture.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCreditAgriculture.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCreditAgriculture.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InvestmentCreditAgriculture,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InvestmentCreditAgriculture,
            "filter_column": "year",
        },
        {
            "param_name": "value",
