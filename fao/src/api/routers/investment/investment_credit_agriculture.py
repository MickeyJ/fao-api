...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in investment_credit_agriculture")
...
@router.get("/item_codes", summary="Get ItemCodes in investment_credit_agriculture")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InvestmentCreditAgriculture, Elements.id == InvestmentCreditAgriculture.element_id)
            .where(Elements.source_dataset == 'investment_credit_agriculture')
            .group_by(
                Elements.element_code,
                Elements.element,
