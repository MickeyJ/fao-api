...
def get_investment_capital_stock(
    ...
    """
    investment capital stock data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, InvestmentCapitalStock.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InvestmentCapitalStock.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InvestmentCapitalStock.element_code_id == Elements.id)
        .outerjoin(Flags, InvestmentCapitalStock.flag_id == Flags.id)
    )
