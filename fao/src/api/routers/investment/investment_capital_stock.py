...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in investment_capital_stock")
...
@router.get("/item_codes", summary="Get ItemCodes in investment_capital_stock")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InvestmentCapitalStock, Elements.id == InvestmentCapitalStock.element_id)
            .where(Elements.source_dataset == 'investment_capital_stock')
            .group_by(
                Elements.element_code,
                Elements.element,
