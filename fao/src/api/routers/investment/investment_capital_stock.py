...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentCapitalStock, AreaCodes.id == InvestmentCapitalStock.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentCapitalStock, ItemCodes.id == InvestmentCapitalStock.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentCapitalStock, Elements.id == InvestmentCapitalStock.element_code_id)
