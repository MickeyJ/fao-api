...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentGovernmentExpenditure, AreaCodes.id == InvestmentGovernmentExpenditure.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentGovernmentExpenditure, ItemCodes.id == InvestmentGovernmentExpenditure.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentGovernmentExpenditure, Elements.id == InvestmentGovernmentExpenditure.element_code_id)
