...
def get_investment_government_expenditure(
    ...
    """
    investment government expenditure data with filters.
    Filter options:
    ...
    query = (
        select(
            InvestmentGovernmentExpenditure,
        ...
        .outerjoin(AreaCodes, InvestmentGovernmentExpenditure.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InvestmentGovernmentExpenditure.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InvestmentGovernmentExpenditure.element_code_id == Elements.id)
        .outerjoin(Flags, InvestmentGovernmentExpenditure.flag_id == Flags.id)
    )
