...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in investment_government_expenditure")
...
@router.get("/item_codes", summary="Get ItemCodes in investment_government_expenditure")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InvestmentGovernmentExpenditure, Elements.id == InvestmentGovernmentExpenditure.element_id)
            .where(Elements.source_dataset == 'investment_government_expenditure')
            .group_by(
                Elements.element_code,
                Elements.element,
