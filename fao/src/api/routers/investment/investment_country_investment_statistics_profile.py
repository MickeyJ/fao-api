...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in investment_country_investment_statistics_profile")
...
@router.get("/item_codes", summary="Get ItemCodes in investment_country_investment_statistics_profile")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InvestmentCountryInvestmentStatisticsProfile, Elements.id == InvestmentCountryInvestmentStatisticsProfile.element_id)
            .where(Elements.source_dataset == 'investment_country_investment_statistics_profile')
            .group_by(
                Elements.element_code,
                Elements.element,
