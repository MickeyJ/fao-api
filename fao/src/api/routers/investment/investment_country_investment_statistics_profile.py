...
def get_investment_country_investment_statistics_profile(
    ...
    """
    investment country investment statistics profile data with filters.
    Filter options:
    ...
    query = (
        select(
            InvestmentCountryInvestmentStatisticsProfile,
        ...
        .outerjoin(AreaCodes, InvestmentCountryInvestmentStatisticsProfile.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InvestmentCountryInvestmentStatisticsProfile.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InvestmentCountryInvestmentStatisticsProfile.element_code_id == Elements.id)
        .outerjoin(Flags, InvestmentCountryInvestmentStatisticsProfile.flag_id == Flags.id)
    )
