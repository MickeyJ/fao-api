...
# Generated as: fao/src/api/routers/investment_government_expenditure_config.py
...
@dataclass
class InvestmentGovernmentExpenditureConfig:
    """Configuration for investment_government_expenditure API"""
    
    # Basic info
    name: str = "investment_government_expenditure"
    model_name: str = "InvestmentGovernmentExpenditure"
    table_name: str = "investment_government_expenditure"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InvestmentGovernmentExpenditure.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentGovernmentExpenditure.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentGovernmentExpenditure.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentGovernmentExpenditure.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InvestmentGovernmentExpenditure,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InvestmentGovernmentExpenditure,
            "filter_column": "year",
        },
        {
            "param_name": "value",
