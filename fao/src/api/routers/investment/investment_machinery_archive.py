...
def get_investment_machinery_archive(
    ...
    """
    investment machinery archive data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, InvestmentMachineryArchive.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InvestmentMachineryArchive.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InvestmentMachineryArchive.element_code_id == Elements.id)
        .outerjoin(Flags, InvestmentMachineryArchive.flag_id == Flags.id)
    )
