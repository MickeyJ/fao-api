...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentMachineryArchive, AreaCodes.id == InvestmentMachineryArchive.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentMachineryArchive, ItemCodes.id == InvestmentMachineryArchive.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentMachineryArchive, Elements.id == InvestmentMachineryArchive.element_code_id)
