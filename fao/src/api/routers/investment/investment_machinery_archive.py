...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in investment_machinery_archive")
...
@router.get("/item_codes", summary="Get ItemCodes in investment_machinery_archive")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InvestmentMachineryArchive, Elements.id == InvestmentMachineryArchive.element_id)
            .where(Elements.source_dataset == 'investment_machinery_archive')
            .group_by(
                Elements.element_code,
                Elements.element,
