...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentForeignDirectInvestment, AreaCodes.id == InvestmentForeignDirectInvestment.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentForeignDirectInvestment, ItemCodes.id == InvestmentForeignDirectInvestment.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InvestmentForeignDirectInvestment, Elements.id == InvestmentForeignDirectInvestment.element_code_id)
