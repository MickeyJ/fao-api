...
def get_investment_foreign_direct_investment(
    ...
    """
    investment foreign direct investment data with filters.
    Filter options:
    ...
    query = (
        select(
            InvestmentForeignDirectInvestment,
        ...
        .outerjoin(AreaCodes, InvestmentForeignDirectInvestment.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InvestmentForeignDirectInvestment.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InvestmentForeignDirectInvestment.element_code_id == Elements.id)
        .outerjoin(Flags, InvestmentForeignDirectInvestment.flag_id == Flags.id)
    )
