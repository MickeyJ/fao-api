...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in investment_foreign_direct_investment")
...
@router.get("/item_codes", summary="Get ItemCodes in investment_foreign_direct_investment")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InvestmentForeignDirectInvestment, Elements.id == InvestmentForeignDirectInvestment.element_id)
            .where(Elements.source_dataset == 'investment_foreign_direct_investment')
            .group_by(
                Elements.element_code,
                Elements.element,
