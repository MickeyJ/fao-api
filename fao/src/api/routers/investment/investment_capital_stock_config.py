...
# Generated as: fao/src/api/routers/investment_capital_stock_config.py
...
@dataclass
class InvestmentCapitalStockConfig:
    """Configuration for investment_capital_stock API"""
    
    # Basic info
    name: str = "investment_capital_stock"
    model_name: str = "InvestmentCapitalStock"
    table_name: str = "investment_capital_stock"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InvestmentCapitalStock.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCapitalStock.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCapitalStock.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCapitalStock.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InvestmentCapitalStock,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InvestmentCapitalStock,
            "filter_column": "year",
        },
        {
            "param_name": "value",
