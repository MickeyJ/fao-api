...
# Generated as: fao/src/api/routers/investment_country_investment_statistics_profile_config.py
...
@dataclass
class InvestmentCountryInvestmentStatisticsProfileConfig:
    """Configuration for investment_country_investment_statistics_profile API"""
    
    # Basic info
    name: str = "investment_country_investment_statistics_profile"
    model_name: str = "InvestmentCountryInvestmentStatisticsProfile"
    table_name: str = "investment_country_investment_statistics_profile"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InvestmentCountryInvestmentStatisticsProfile.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCountryInvestmentStatisticsProfile.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCountryInvestmentStatisticsProfile.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InvestmentCountryInvestmentStatisticsProfile.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InvestmentCountryInvestmentStatisticsProfile,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InvestmentCountryInvestmentStatisticsProfile,
            "filter_column": "year",
        },
        {
            "param_name": "value",
