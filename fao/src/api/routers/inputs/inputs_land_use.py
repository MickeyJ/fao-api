...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsLandUse, AreaCodes.id == InputsLandUse.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsLandUse, ItemCodes.id == InputsLandUse.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsLandUse, Elements.id == InputsLandUse.element_code_id)
