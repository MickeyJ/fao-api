...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in inputs_land_use")
...
@router.get("/item_codes", summary="Get ItemCodes in inputs_land_use")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InputsLandUse, Elements.id == InputsLandUse.element_id)
            .where(Elements.source_dataset == 'inputs_land_use')
            .group_by(
                Elements.element_code,
                Elements.element,
