...
def get_inputs_land_use(
    ...
    """
    inputs land use data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, InputsLandUse.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InputsLandUse.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InputsLandUse.element_code_id == Elements.id)
        .outerjoin(Flags, InputsLandUse.flag_id == Flags.id)
    )
