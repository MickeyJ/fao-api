...
# Generated as: fao/src/api/routers/inputs_land_use_config.py
...
@dataclass
class InputsLandUseConfig:
    """Configuration for inputs_land_use API"""
    
    # Basic info
    name: str = "inputs_land_use"
    model_name: str = "InputsLandUse"
    table_name: str = "inputs_land_use"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InputsLandUse.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsLandUse.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsLandUse.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsLandUse.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InputsLandUse,  # <-- Actual model class
