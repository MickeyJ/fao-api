...
# Generated as: fao/src/api/routers/inputs_pesticides_trade_config.py
...
@dataclass
class InputsPesticidesTradeConfig:
    """Configuration for inputs_pesticides_trade API"""
    
    # Basic info
    name: str = "inputs_pesticides_trade"
    model_name: str = "InputsPesticidesTrade"
    table_name: str = "inputs_pesticides_trade"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InputsPesticidesTrade.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsPesticidesTrade.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsPesticidesTrade.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsPesticidesTrade.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InputsPesticidesTrade,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InputsPesticidesTrade,
            "filter_column": "year",
        },
        {
            "param_name": "value",
