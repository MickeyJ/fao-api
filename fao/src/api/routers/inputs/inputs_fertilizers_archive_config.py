...
# Generated as: fao/src/api/routers/inputs_fertilizers_archive_config.py
...
@dataclass
class InputsFertilizersArchiveConfig:
    """Configuration for inputs_fertilizers_archive API"""
    
    # Basic info
    name: str = "inputs_fertilizers_archive"
    model_name: str = "InputsFertilizersArchive"
    table_name: str = "inputs_fertilizers_archive"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InputsFertilizersArchive.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersArchive.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersArchive.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersArchive.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InputsFertilizersArchive,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InputsFertilizersArchive,
            "filter_column": "year",
        },
        {
            "param_name": "value",
