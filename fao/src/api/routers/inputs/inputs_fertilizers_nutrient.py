...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsFertilizersNutrient, AreaCodes.id == InputsFertilizersNutrient.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsFertilizersNutrient, ItemCodes.id == InputsFertilizersNutrient.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsFertilizersNutrient, Elements.id == InputsFertilizersNutrient.element_code_id)
