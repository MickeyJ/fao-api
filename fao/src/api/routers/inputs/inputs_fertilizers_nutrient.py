...
router = APIRouter(
    ...
    tags=["inputs_fertilizers_nutrient"],
...
def get_inputs_fertilizers_nutrient(
    ...
    """
    inputs fertilizers nutrient data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, InputsFertilizersNutrient.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InputsFertilizersNutrient.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InputsFertilizersNutrient.element_code_id == Elements.id)
        .outerjoin(Flags, InputsFertilizersNutrient.flag_id == Flags.id)
    )
