...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in inputs_fertilizers_nutrient")
...
@router.get("/item_codes", summary="Get ItemCodes in inputs_fertilizers_nutrient")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InputsFertilizersNutrient, Elements.id == InputsFertilizersNutrient.element_id)
            .where(Elements.source_dataset == 'inputs_fertilizers_nutrient')
            .group_by(
                Elements.element_code,
                Elements.element,
