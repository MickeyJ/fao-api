...
# Generated as: fao/src/api/routers/inputs_fertilizers_product_config.py
...
@dataclass
class InputsFertilizersProductConfig:
    """Configuration for inputs_fertilizers_product API"""
    
    # Basic info
    name: str = "inputs_fertilizers_product"
    model_name: str = "InputsFertilizersProduct"
    table_name: str = "inputs_fertilizers_product"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InputsFertilizersProduct.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersProduct.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersProduct.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersProduct.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InputsFertilizersProduct,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InputsFertilizersProduct,
            "filter_column": "year",
        },
        {
            "param_name": "value",
