...
# Generated as: fao/src/api/routers/inputs_fertilizers_nutrient_config.py
...
@dataclass
class InputsFertilizersNutrientConfig:
    """Configuration for inputs_fertilizers_nutrient API"""
    
    # Basic info
    name: str = "inputs_fertilizers_nutrient"
    model_name: str = "InputsFertilizersNutrient"
    table_name: str = "inputs_fertilizers_nutrient"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InputsFertilizersNutrient.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersNutrient.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersNutrient.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsFertilizersNutrient.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InputsFertilizersNutrient,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InputsFertilizersNutrient,
            "filter_column": "year",
        },
        {
            "param_name": "value",
