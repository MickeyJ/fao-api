...
# Generated as: fao/src/api/routers/inputs_pesticides_use_config.py
...
@dataclass
class InputsPesticidesUseConfig:
    """Configuration for inputs_pesticides_use API"""
    
    # Basic info
    name: str = "inputs_pesticides_use"
    model_name: str = "InputsPesticidesUse"
    table_name: str = "inputs_pesticides_use"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": InputsPesticidesUse.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsPesticidesUse.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsPesticidesUse.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": InputsPesticidesUse.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": InputsPesticidesUse,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": InputsPesticidesUse,
            "filter_column": "year",
        },
        {
            "param_name": "value",
