...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in inputs_fertilizers_archive")
...
@router.get("/item_codes", summary="Get ItemCodes in inputs_fertilizers_archive")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InputsFertilizersArchive, Elements.id == InputsFertilizersArchive.element_id)
            .where(Elements.source_dataset == 'inputs_fertilizers_archive')
            .group_by(
                Elements.element_code,
                Elements.element,
