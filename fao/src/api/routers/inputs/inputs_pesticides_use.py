...
def get_inputs_pesticides_use(
    ...
    """
    inputs pesticides use data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, InputsPesticidesUse.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InputsPesticidesUse.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InputsPesticidesUse.element_code_id == Elements.id)
        .outerjoin(Flags, InputsPesticidesUse.flag_id == Flags.id)
    )
