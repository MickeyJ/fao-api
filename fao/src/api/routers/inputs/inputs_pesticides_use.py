...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsPesticidesUse, AreaCodes.id == InputsPesticidesUse.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsPesticidesUse, ItemCodes.id == InputsPesticidesUse.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsPesticidesUse, Elements.id == InputsPesticidesUse.element_code_id)
