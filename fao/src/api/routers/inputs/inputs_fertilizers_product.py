...
router = APIRouter(
    ...
    tags=["inputs_fertilizers_product"],
...
def get_inputs_fertilizers_product(
    ...
    """
    inputs fertilizers product data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, InputsFertilizersProduct.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, InputsFertilizersProduct.item_code_id == ItemCodes.id)
        .outerjoin(Elements, InputsFertilizersProduct.element_code_id == Elements.id)
        .outerjoin(Flags, InputsFertilizersProduct.flag_id == Flags.id)
    )
