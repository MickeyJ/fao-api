...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsFertilizersProduct, AreaCodes.id == InputsFertilizersProduct.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsFertilizersProduct, ItemCodes.id == InputsFertilizersProduct.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(InputsFertilizersProduct, Elements.id == InputsFertilizersProduct.element_code_id)
