...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in inputs_pesticides_trade")
...
@router.get("/item_codes", summary="Get ItemCodes in inputs_pesticides_trade")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(InputsPesticidesTrade, Elements.id == InputsPesticidesTrade.element_id)
            .where(Elements.source_dataset == 'inputs_pesticides_trade')
            .group_by(
                Elements.element_code,
                Elements.element,
