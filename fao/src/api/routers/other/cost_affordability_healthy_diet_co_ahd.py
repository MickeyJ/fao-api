...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in cost_affordability_healthy_diet_co_ahd")
...
@router.get("/item_codes", summary="Get ItemCodes in cost_affordability_healthy_diet_co_ahd")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(CostAffordabilityHealthyDietCoAhd, Elements.id == CostAffordabilityHealthyDietCoAhd.element_id)
            .where(Elements.source_dataset == 'cost_affordability_healthy_diet_co_ahd')
            .group_by(
                Elements.element_code,
                Elements.element,
