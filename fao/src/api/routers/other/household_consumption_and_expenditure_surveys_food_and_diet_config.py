...
# Generated as: fao/src/api/routers/household_consumption_and_expenditure_surveys_food_and_diet_config.py
...
@dataclass
class HouseholdConsumptionAndExpenditureSurveysFoodAndDietConfig:
    """Configuration for household_consumption_and_expenditure_surveys_food_and_diet API"""
    
    # Basic info
    name: str = "household_consumption_and_expenditure_surveys_food_and_diet"
    model_name: str = "HouseholdConsumptionAndExpenditureSurveysFoodAndDiet"
    table_name: str = "household_consumption_and_expenditure_surveys_food_and_diet"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": HouseholdConsumptionAndExpenditureSurveysFoodAndDiet.survey_code_id,
        },
        {
            "name": "survey",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": HouseholdConsumptionAndExpenditureSurveysFoodAndDiet.geographic_level_code_id,
        },
        {
        ...
        },
        {
            ...
            "join_condition": HouseholdConsumptionAndExpenditureSurveysFoodAndDiet.food_group_code_id,
        },
        {
            "name": "food_group",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": HouseholdConsumptionAndExpenditureSurveysFoodAndDiet.indicator_code_id,
        },
        {
            "name": "indicator",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": HouseholdConsumptionAndExpenditureSurveysFoodAndDiet.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": HouseholdConsumptionAndExpenditureSurveysFoodAndDiet.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "unit",
            "filter_type": "like",
            "filter_model": HouseholdConsumptionAndExpenditureSurveysFoodAndDiet,  # <-- Actual model class
            "filter_column": "unit",
        },
        {
            "name": "value",
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "value",
            "filter_model": HouseholdConsumptionAndExpenditureSurveysFoodAndDiet,
            "filter_column": "value",
        },
    ])