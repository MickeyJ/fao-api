...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in macro_statistics_key_indicators")
...
@router.get("/item_codes", summary="Get ItemCodes in macro_statistics_key_indicators")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(MacroStatisticsKeyIndicators, Elements.id == MacroStatisticsKeyIndicators.element_id)
            .where(Elements.source_dataset == 'macro_statistics_key_indicators')
            .group_by(
                Elements.element_code,
                Elements.element,
