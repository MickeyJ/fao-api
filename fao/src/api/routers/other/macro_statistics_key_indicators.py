...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(MacroStatisticsKeyIndicators, AreaCodes.id == MacroStatisticsKeyIndicators.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(MacroStatisticsKeyIndicators, ItemCodes.id == MacroStatisticsKeyIndicators.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(MacroStatisticsKeyIndicators, Elements.id == MacroStatisticsKeyIndicators.element_code_id)
