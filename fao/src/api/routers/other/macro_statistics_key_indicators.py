...
def get_macro_statistics_key_indicators(
    ...
    """
    macro statistics key indicators data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, MacroStatisticsKeyIndicators.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, MacroStatisticsKeyIndicators.item_code_id == ItemCodes.id)
        .outerjoin(Elements, MacroStatisticsKeyIndicators.element_code_id == Elements.id)
        .outerjoin(Flags, MacroStatisticsKeyIndicators.flag_id == Flags.id)
    )
