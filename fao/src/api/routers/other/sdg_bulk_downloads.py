...
def get_sdg_bulk_downloads(
    ...
    """
    sdg bulk downloads data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, SdgBulkDownloads.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, SdgBulkDownloads.item_code_id == ItemCodes.id)
        .outerjoin(Elements, SdgBulkDownloads.element_code_id == Elements.id)
        .outerjoin(Flags, SdgBulkDownloads.flag_id == Flags.id)
    )
