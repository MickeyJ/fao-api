...
# Generated as: fao/src/api/routers/macro_statistics_key_indicators_config.py
...
@dataclass
class MacroStatisticsKeyIndicatorsConfig:
    """Configuration for macro_statistics_key_indicators API"""
    
    # Basic info
    name: str = "macro_statistics_key_indicators"
    model_name: str = "MacroStatisticsKeyIndicators"
    table_name: str = "macro_statistics_key_indicators"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": MacroStatisticsKeyIndicators.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": MacroStatisticsKeyIndicators.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": MacroStatisticsKeyIndicators.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": MacroStatisticsKeyIndicators.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": MacroStatisticsKeyIndicators,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": MacroStatisticsKeyIndicators,
            "filter_column": "year",
        },
        {
            "param_name": "value",
