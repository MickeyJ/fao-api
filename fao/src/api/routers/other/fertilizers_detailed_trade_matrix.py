...
def get_fertilizers_detailed_trade_matrix(
    ...
    """
    fertilizers detailed trade matrix data with filters.
    Filter options:
    ...
    query = (
        select(
            FertilizersDetailedTradeMatrix,
        ...
        .outerjoin(ItemCodes, FertilizersDetailedTradeMatrix.item_code_id == ItemCodes.id)
        .outerjoin(Elements, FertilizersDetailedTradeMatrix.element_code_id == Elements.id)
        .outerjoin(Flags, FertilizersDetailedTradeMatrix.flag_id == Flags.id)
    )
