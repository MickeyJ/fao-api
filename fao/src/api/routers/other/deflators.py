...
def get_deflators(
    ...
    query = (
        ...
        .outerjoin(AreaCodes, Deflators.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, Deflators.item_code_id == ItemCodes.id)
        .outerjoin(Elements, Deflators.element_code_id == Elements.id)
        .outerjoin(Flags, Deflators.flag_id == Flags.id)
    )
