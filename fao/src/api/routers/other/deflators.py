...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(Deflators, AreaCodes.id == Deflators.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(Deflators, ItemCodes.id == Deflators.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(Deflators, Elements.id == Deflators.element_code_id)
