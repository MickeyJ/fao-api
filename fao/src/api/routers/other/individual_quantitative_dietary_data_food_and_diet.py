...
@router.get("/surveys")
@cache_result(prefix="individual_quantitative_dietary_data_food_and_diet:surveys", ttl=604800)
def get_available_surveys(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .where(Surveys.source_dataset == 'individual_quantitative_dietary_data_food_and_diet')
...
@cache_result(prefix="individual_quantitative_dietary_data_food_and_diet:geographic_levels", ttl=604800)
def get_available_geographic_levels(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .where(GeographicLevels.source_dataset == 'individual_quantitative_dietary_data_food_and_diet')
...
@cache_result(prefix="individual_quantitative_dietary_data_food_and_diet:population_age_groups", ttl=604800)
def get_available_population_age_groups(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .where(PopulationAgeGroups.source_dataset == 'individual_quantitative_dietary_data_food_and_diet')
...
@cache_result(prefix="individual_quantitative_dietary_data_food_and_diet:food_groups", ttl=604800)
def get_available_food_groups(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .where(FoodGroups.source_dataset == 'individual_quantitative_dietary_data_food_and_diet')
...
@cache_result(prefix="individual_quantitative_dietary_data_food_and_diet:indicators", ttl=604800)
def get_available_indicators(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .where(Indicators.source_dataset == 'individual_quantitative_dietary_data_food_and_diet')
...
@router.get("/sexs")
@cache_result(prefix="individual_quantitative_dietary_data_food_and_diet:sexs", ttl=604800)
def get_available_sexs(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .where(Sexs.source_dataset == 'individual_quantitative_dietary_data_food_and_diet')
...
def get_dataset_summary(db: Session = Depends(get_db)):
    ...
    summary["unique_surveys"] = db.query(func.count(func.distinct(IndividualQuantitativeDietaryDataFoodAndDiet.survey_code_id))).scalar()
    summary["unique_geographic_levels"] = db.query(func.count(func.distinct(IndividualQuantitativeDietaryDataFoodAndDiet.geographic_level_code_id))).scalar()
    summary["unique_population_age_groups"] = db.query(func.count(func.distinct(IndividualQuantitativeDietaryDataFoodAndDiet.population_age_group_code_id))).scalar()
    summary["unique_food_groups"] = db.query(func.count(func.distinct(IndividualQuantitativeDietaryDataFoodAndDiet.food_group_code_id))).scalar()
    summary["unique_indicators"] = db.query(func.count(func.distinct(IndividualQuantitativeDietaryDataFoodAndDiet.indicator_code_id))).scalar()
    ...
    summary["unique_sexs"] = db.query(func.count(func.distinct(IndividualQuantitativeDietaryDataFoodAndDiet.sex_code_id))).scalar()
    summary["unique_flags"] = db.query(func.count(func.distinct(IndividualQuantitativeDietaryDataFoodAndDiet.flag_id))).scalar()
