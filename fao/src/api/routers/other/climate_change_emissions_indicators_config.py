...
# Generated as: fao/src/api/routers/climate_change_emissions_indicators_config.py
...
@dataclass
class ClimateChangeEmissionsIndicatorsConfig:
    """Configuration for climate_change_emissions_indicators API"""
    
    # Basic info
    name: str = "climate_change_emissions_indicators"
    model_name: str = "ClimateChangeEmissionsIndicators"
    table_name: str = "climate_change_emissions_indicators"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": ClimateChangeEmissionsIndicators.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ClimateChangeEmissionsIndicators.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ClimateChangeEmissionsIndicators.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ClimateChangeEmissionsIndicators.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": ClimateChangeEmissionsIndicators,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": ClimateChangeEmissionsIndicators,
            "filter_column": "year",
        },
        {
            "param_name": "value",
