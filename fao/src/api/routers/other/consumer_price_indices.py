...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in consumer_price_indices")
...
@router.get("/item_codes", summary="Get ItemCodes in consumer_price_indices")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(ConsumerPriceIndices, Elements.id == ConsumerPriceIndices.element_id)
            .where(Elements.source_dataset == 'consumer_price_indices')
            .group_by(
                Elements.element_code,
                Elements.element,
