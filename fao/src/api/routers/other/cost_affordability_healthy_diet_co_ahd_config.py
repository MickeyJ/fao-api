...
# Generated as: fao/src/api/routers/cost_affordability_healthy_diet_co_ahd_config.py
...
@dataclass
class CostAffordabilityHealthyDietCoAhdConfig:
    """Configuration for cost_affordability_healthy_diet_co_ahd API"""
    
    # Basic info
    name: str = "cost_affordability_healthy_diet_co_ahd"
    model_name: str = "CostAffordabilityHealthyDietCoAhd"
    table_name: str = "cost_affordability_healthy_diet_co_ahd"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": CostAffordabilityHealthyDietCoAhd.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CostAffordabilityHealthyDietCoAhd.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CostAffordabilityHealthyDietCoAhd.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "joins_table": "release_code_id",
            "join_model": Releases,  # <-- Actual model class
            "join_condition": CostAffordabilityHealthyDietCoAhd.release_code_id,
        },
        {
            "name": "release",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": CostAffordabilityHealthyDietCoAhd.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": CostAffordabilityHealthyDietCoAhd,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": CostAffordabilityHealthyDietCoAhd,
            "filter_column": "year",
        },
        {
            "param_name": "value",
