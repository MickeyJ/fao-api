...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/recipient_country_codes", summary="Get RecipientCountryCodes in development_assistance_to_agriculture")
    ...
    if include_distribution:
        query = (
            ...
            .join(DevelopmentAssistanceToAgriculture, 
                DevelopmentAssistanceToAgriculture.recipient_country_code_id == RecipientCountryCodes.id)
            .where(RecipientCountryCodes.source_dataset == 'development_assistance_to_agriculture')
        )
...
@router.get("/item_codes", summary="Get ItemCodes in development_assistance_to_agriculture")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(DevelopmentAssistanceToAgriculture, Elements.id == DevelopmentAssistanceToAgriculture.element_id)
            .where(Elements.source_dataset == 'development_assistance_to_agriculture')
            .group_by(
                Elements.element_code,
                Elements.element,
