...
# Generated as: fao/src/api/routers/consumer_price_indices_config.py
...
@dataclass
class ConsumerPriceIndicesConfig:
    """Configuration for consumer_price_indices API"""
    
    # Basic info
    name: str = "consumer_price_indices"
    model_name: str = "ConsumerPriceIndices"
    table_name: str = "consumer_price_indices"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": ConsumerPriceIndices.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ConsumerPriceIndices.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ConsumerPriceIndices.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": ConsumerPriceIndices.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "months_code",
            "filter_type": "like",
            "filter_model": ConsumerPriceIndices,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": ConsumerPriceIndices,
            "filter_column": "year",
        },
        {
            "param_name": "value",
