...
# Generated as: fao/src/api/routers/sua_crops_livestock_config.py
...
@dataclass
class SuaCropsLivestockConfig:
    """Configuration for sua_crops_livestock API"""
    
    # Basic info
    name: str = "sua_crops_livestock"
    model_name: str = "SuaCropsLivestock"
    table_name: str = "sua_crops_livestock"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": SuaCropsLivestock.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": SuaCropsLivestock.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": SuaCropsLivestock.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": SuaCropsLivestock.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": SuaCropsLivestock,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": SuaCropsLivestock,
            "filter_column": "year",
        },
        {
            "param_name": "value",
