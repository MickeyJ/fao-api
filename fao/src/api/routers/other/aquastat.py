...
def get_aquastat(
    ...
    query = (
        ...
        .outerjoin(AreaCodes, Aquastat.area_code_id == AreaCodes.id)
        .outerjoin(Elements, Aquastat.element_code_id == Elements.id)
        .outerjoin(Flags, Aquastat.flag_id == Flags.id)
    )
