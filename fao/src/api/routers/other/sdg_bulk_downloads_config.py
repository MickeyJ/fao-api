...
# Generated as: fao/src/api/routers/sdg_bulk_downloads_config.py
...
@dataclass
class SdgBulkDownloadsConfig:
    """Configuration for sdg_bulk_downloads API"""
    
    # Basic info
    name: str = "sdg_bulk_downloads"
    model_name: str = "SdgBulkDownloads"
    table_name: str = "sdg_bulk_downloads"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": SdgBulkDownloads.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": SdgBulkDownloads.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": SdgBulkDownloads.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": SdgBulkDownloads.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": SdgBulkDownloads,  # <-- Actual model class
