...
def get_minimum_dietary_diversity_for_women_mdd_w_food_and_diet(
    ...
    """
    minimum dietary diversity for women mdd w food and diet data with filters.
    Filter options:
    ...
    query = (
        select(
            MinimumDietaryDiversityForWomenMddWFoodAndDiet,
        ...
        .outerjoin(FoodGroups, MinimumDietaryDiversityForWomenMddWFoodAndDiet.food_group_code_id == FoodGroups.id)
        .outerjoin(Indicators, MinimumDietaryDiversityForWomenMddWFoodAndDiet.indicator_code_id == Indicators.id)
        .outerjoin(GeographicLevels, MinimumDietaryDiversityForWomenMddWFoodAndDiet.geographic_level_code_id == GeographicLevels.id)
        .outerjoin(Elements, MinimumDietaryDiversityForWomenMddWFoodAndDiet.element_code_id == Elements.id)
        .outerjoin(Flags, MinimumDietaryDiversityForWomenMddWFoodAndDiet.flag_id == Flags.id)
    )
