...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(SuaCropsLivestock, AreaCodes.id == SuaCropsLivestock.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(SuaCropsLivestock, ItemCodes.id == SuaCropsLivestock.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(SuaCropsLivestock, Elements.id == SuaCropsLivestock.element_code_id)
