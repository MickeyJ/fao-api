...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in sua_crops_livestock")
...
@router.get("/item_codes", summary="Get ItemCodes in sua_crops_livestock")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(SuaCropsLivestock, Elements.id == SuaCropsLivestock.element_id)
            .where(Elements.source_dataset == 'sua_crops_livestock')
            .group_by(
                Elements.element_code,
                Elements.element,
