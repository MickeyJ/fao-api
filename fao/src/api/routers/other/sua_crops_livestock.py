...
def get_sua_crops_livestock(
    ...
    """
    sua crops livestock data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, SuaCropsLivestock.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, SuaCropsLivestock.item_code_id == ItemCodes.id)
        .outerjoin(Elements, SuaCropsLivestock.element_code_id == Elements.id)
        .outerjoin(Flags, SuaCropsLivestock.flag_id == Flags.id)
    )
