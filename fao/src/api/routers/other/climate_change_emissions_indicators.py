...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in climate_change_emissions_indicators")
...
@router.get("/item_codes", summary="Get ItemCodes in climate_change_emissions_indicators")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(ClimateChangeEmissionsIndicators, Elements.id == ClimateChangeEmissionsIndicators.element_id)
            .where(Elements.source_dataset == 'climate_change_emissions_indicators')
            .group_by(
                Elements.element_code,
                Elements.element,
