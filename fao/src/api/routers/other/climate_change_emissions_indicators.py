...
def get_climate_change_emissions_indicators(
    ...
    """
    climate change emissions indicators data with filters.
    Filter options:
    ...
    query = (
        select(
            ClimateChangeEmissionsIndicators,
        ...
        .outerjoin(AreaCodes, ClimateChangeEmissionsIndicators.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, ClimateChangeEmissionsIndicators.item_code_id == ItemCodes.id)
        .outerjoin(Elements, ClimateChangeEmissionsIndicators.element_code_id == Elements.id)
        .outerjoin(Flags, ClimateChangeEmissionsIndicators.flag_id == Flags.id)
    )
