...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ClimateChangeEmissionsIndicators, AreaCodes.id == ClimateChangeEmissionsIndicators.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ClimateChangeEmissionsIndicators, ItemCodes.id == ClimateChangeEmissionsIndicators.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(ClimateChangeEmissionsIndicators, Elements.id == ClimateChangeEmissionsIndicators.element_code_id)
