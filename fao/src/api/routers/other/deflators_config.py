...
# Generated as: fao/src/api/routers/deflators_config.py
...
@dataclass
class DeflatorsConfig:
    """Configuration for deflators API"""
    
    # Basic info
    name: str = "deflators"
    model_name: str = "Deflators"
    table_name: str = "deflators"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": Deflators.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Deflators.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Deflators.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Deflators.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": Deflators,  # <-- Actual model class
