...
# Generated as: fao/src/api/routers/population_config.py
...
class PopulationConfig:
    """Configuration for population API"""
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": Population.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Population.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Population.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Population.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": Population,  # <-- Actual model class
