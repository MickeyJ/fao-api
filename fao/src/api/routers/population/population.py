...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(Population, AreaCodes.id == Population.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(Population, ItemCodes.id == Population.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(Population, Elements.id == Population.element_code_id)
