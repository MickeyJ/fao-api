...
def get_population(
    ...
    query = (
        ...
        .outerjoin(AreaCodes, Population.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, Population.item_code_id == ItemCodes.id)
        .outerjoin(Elements, Population.element_code_id == Elements.id)
        .outerjoin(Flags, Population.flag_id == Flags.id)
    )
