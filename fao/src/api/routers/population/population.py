...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in population")
...
@router.get("/item_codes", summary="Get ItemCodes in population")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(Population, Elements.id == Population.element_id)
            .where(Elements.source_dataset == 'population')
            .group_by(
                Elements.element_code,
                Elements.element,
