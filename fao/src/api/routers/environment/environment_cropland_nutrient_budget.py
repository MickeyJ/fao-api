...
def get_environment_cropland_nutrient_budget(
    ...
    """
    environment cropland nutrient budget data with filters.
    Filter options:
    ...
    query = (
        select(
            EnvironmentCroplandNutrientBudget,
        ...
        .outerjoin(AreaCodes, EnvironmentCroplandNutrientBudget.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EnvironmentCroplandNutrientBudget.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EnvironmentCroplandNutrientBudget.element_code_id == Elements.id)
        .outerjoin(Flags, EnvironmentCroplandNutrientBudget.flag_id == Flags.id)
    )
