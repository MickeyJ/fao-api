...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in environment_cropland_nutrient_budget")
...
@router.get("/item_codes", summary="Get ItemCodes in environment_cropland_nutrient_budget")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EnvironmentCroplandNutrientBudget, Elements.id == EnvironmentCroplandNutrientBudget.element_id)
            .where(Elements.source_dataset == 'environment_cropland_nutrient_budget')
            .group_by(
                Elements.element_code,
                Elements.element,
