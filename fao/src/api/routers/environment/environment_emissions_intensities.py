...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentEmissionsIntensities, AreaCodes.id == EnvironmentEmissionsIntensities.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentEmissionsIntensities, ItemCodes.id == EnvironmentEmissionsIntensities.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentEmissionsIntensities, Elements.id == EnvironmentEmissionsIntensities.element_code_id)
