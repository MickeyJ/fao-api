...
def get_environment_emissions_intensities(
    ...
    """
    environment emissions intensities data with filters.
    Filter options:
    ...
    query = (
        select(
            EnvironmentEmissionsIntensities,
        ...
        .outerjoin(AreaCodes, EnvironmentEmissionsIntensities.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EnvironmentEmissionsIntensities.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EnvironmentEmissionsIntensities.element_code_id == Elements.id)
        .outerjoin(Flags, EnvironmentEmissionsIntensities.flag_id == Flags.id)
    )
