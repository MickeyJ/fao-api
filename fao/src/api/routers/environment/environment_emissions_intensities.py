...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in environment_emissions_intensities")
...
@router.get("/item_codes", summary="Get ItemCodes in environment_emissions_intensities")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EnvironmentEmissionsIntensities, Elements.id == EnvironmentEmissionsIntensities.element_id)
            .where(Elements.source_dataset == 'environment_emissions_intensities')
            .group_by(
                Elements.element_code,
                Elements.element,
