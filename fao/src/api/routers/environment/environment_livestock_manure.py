...
def get_environment_livestock_manure(
    ...
    """
    environment livestock manure data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EnvironmentLivestockManure.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EnvironmentLivestockManure.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EnvironmentLivestockManure.element_code_id == Elements.id)
        .outerjoin(Flags, EnvironmentLivestockManure.flag_id == Flags.id)
    )
