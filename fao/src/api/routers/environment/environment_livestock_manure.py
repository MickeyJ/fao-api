...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentLivestockManure, AreaCodes.id == EnvironmentLivestockManure.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentLivestockManure, ItemCodes.id == EnvironmentLivestockManure.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentLivestockManure, Elements.id == EnvironmentLivestockManure.element_code_id)
