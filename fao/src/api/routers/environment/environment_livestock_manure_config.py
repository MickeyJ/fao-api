...
# Generated as: fao/src/api/routers/environment_livestock_manure_config.py
...
@dataclass
class EnvironmentLivestockManureConfig:
    """Configuration for environment_livestock_manure API"""
    
    # Basic info
    name: str = "environment_livestock_manure"
    model_name: str = "EnvironmentLivestockManure"
    table_name: str = "environment_livestock_manure"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EnvironmentLivestockManure.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLivestockManure.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLivestockManure.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLivestockManure.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EnvironmentLivestockManure,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EnvironmentLivestockManure,
            "filter_column": "year",
        },
        {
            "param_name": "value",
