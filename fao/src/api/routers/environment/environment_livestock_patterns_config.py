...
# Generated as: fao/src/api/routers/environment_livestock_patterns_config.py
...
@dataclass
class EnvironmentLivestockPatternsConfig:
    """Configuration for environment_livestock_patterns API"""
    
    # Basic info
    name: str = "environment_livestock_patterns"
    model_name: str = "EnvironmentLivestockPatterns"
    table_name: str = "environment_livestock_patterns"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EnvironmentLivestockPatterns.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLivestockPatterns.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLivestockPatterns.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLivestockPatterns.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EnvironmentLivestockPatterns,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EnvironmentLivestockPatterns,
            "filter_column": "year",
        },
        {
            "param_name": "value",
