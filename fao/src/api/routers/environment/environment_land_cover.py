...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in environment_land_cover")
...
@router.get("/item_codes", summary="Get ItemCodes in environment_land_cover")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EnvironmentLandCover, Elements.id == EnvironmentLandCover.element_id)
            .where(Elements.source_dataset == 'environment_land_cover')
            .group_by(
                Elements.element_code,
                Elements.element,
