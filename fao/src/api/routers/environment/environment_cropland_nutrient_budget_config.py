...
# Generated as: fao/src/api/routers/environment_cropland_nutrient_budget_config.py
...
@dataclass
class EnvironmentCroplandNutrientBudgetConfig:
    """Configuration for environment_cropland_nutrient_budget API"""
    
    # Basic info
    name: str = "environment_cropland_nutrient_budget"
    model_name: str = "EnvironmentCroplandNutrientBudget"
    table_name: str = "environment_cropland_nutrient_budget"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EnvironmentCroplandNutrientBudget.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentCroplandNutrientBudget.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentCroplandNutrientBudget.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentCroplandNutrientBudget.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EnvironmentCroplandNutrientBudget,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EnvironmentCroplandNutrientBudget,
            "filter_column": "year",
        },
        {
            "param_name": "value",
