...
def get_environment_bioenergy(
    ...
    """
    environment bioenergy data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EnvironmentBioenergy.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EnvironmentBioenergy.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EnvironmentBioenergy.element_code_id == Elements.id)
        .outerjoin(Flags, EnvironmentBioenergy.flag_id == Flags.id)
    )
