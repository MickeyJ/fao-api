...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in environment_bioenergy")
...
@router.get("/item_codes", summary="Get ItemCodes in environment_bioenergy")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EnvironmentBioenergy, Elements.id == EnvironmentBioenergy.element_id)
            .where(Elements.source_dataset == 'environment_bioenergy')
            .group_by(
                Elements.element_code,
                Elements.element,
