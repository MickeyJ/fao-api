...
# Generated as: fao/src/api/routers/environment_temperature_change_config.py
...
@dataclass
class EnvironmentTemperatureChangeConfig:
    """Configuration for environment_temperature_change API"""
    
    # Basic info
    name: str = "environment_temperature_change"
    model_name: str = "EnvironmentTemperatureChange"
    table_name: str = "environment_temperature_change"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EnvironmentTemperatureChange.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentTemperatureChange.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentTemperatureChange.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "months_code",
            "filter_type": "like",
            "filter_model": EnvironmentTemperatureChange,  # <-- Actual model class
            "filter_column": "months_code",
        },
        {
            "name": "months",
            "filter_type": "like",
            "filter_model": EnvironmentTemperatureChange,  # <-- Actual model class
            "filter_column": "months",
        },
        {
            "name": "year_code",
            "filter_type": "like",
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EnvironmentTemperatureChange,
            "filter_column": "year",
        },
        {
            "param_name": "value",
