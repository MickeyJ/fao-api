...
# Generated as: fao/src/api/routers/environment_land_cover_config.py
...
@dataclass
class EnvironmentLandCoverConfig:
    """Configuration for environment_land_cover API"""
    
    # Basic info
    name: str = "environment_land_cover"
    model_name: str = "EnvironmentLandCover"
    table_name: str = "environment_land_cover"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EnvironmentLandCover.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLandCover.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLandCover.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentLandCover.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EnvironmentLandCover,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EnvironmentLandCover,
            "filter_column": "year",
        },
        {
            "param_name": "value",
