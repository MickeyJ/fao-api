...
# Generated as: fao/src/api/routers/environment_emissions_intensities_config.py
...
@dataclass
class EnvironmentEmissionsIntensitiesConfig:
    """Configuration for environment_emissions_intensities API"""
    
    # Basic info
    name: str = "environment_emissions_intensities"
    model_name: str = "EnvironmentEmissionsIntensities"
    table_name: str = "environment_emissions_intensities"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EnvironmentEmissionsIntensities.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentEmissionsIntensities.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentEmissionsIntensities.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentEmissionsIntensities.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EnvironmentEmissionsIntensities,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EnvironmentEmissionsIntensities,
            "filter_column": "year",
        },
        {
            "param_name": "value",
