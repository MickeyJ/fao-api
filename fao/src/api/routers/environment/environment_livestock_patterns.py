...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentLivestockPatterns, AreaCodes.id == EnvironmentLivestockPatterns.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentLivestockPatterns, ItemCodes.id == EnvironmentLivestockPatterns.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EnvironmentLivestockPatterns, Elements.id == EnvironmentLivestockPatterns.element_code_id)
