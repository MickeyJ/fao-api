...
def get_environment_livestock_patterns(
    ...
    """
    environment livestock patterns data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EnvironmentLivestockPatterns.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EnvironmentLivestockPatterns.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EnvironmentLivestockPatterns.element_code_id == Elements.id)
        .outerjoin(Flags, EnvironmentLivestockPatterns.flag_id == Flags.id)
    )
