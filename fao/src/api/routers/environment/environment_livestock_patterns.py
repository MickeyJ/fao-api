...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in environment_livestock_patterns")
...
@router.get("/item_codes", summary="Get ItemCodes in environment_livestock_patterns")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EnvironmentLivestockPatterns, Elements.id == EnvironmentLivestockPatterns.element_id)
            .where(Elements.source_dataset == 'environment_livestock_patterns')
            .group_by(
                Elements.element_code,
                Elements.element,
