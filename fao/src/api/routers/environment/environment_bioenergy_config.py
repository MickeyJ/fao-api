...
# Generated as: fao/src/api/routers/environment_bioenergy_config.py
...
@dataclass
class EnvironmentBioenergyConfig:
    """Configuration for environment_bioenergy API"""
    
    # Basic info
    name: str = "environment_bioenergy"
    model_name: str = "EnvironmentBioenergy"
    table_name: str = "environment_bioenergy"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EnvironmentBioenergy.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentBioenergy.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentBioenergy.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EnvironmentBioenergy.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EnvironmentBioenergy,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EnvironmentBioenergy,
            "filter_column": "year",
        },
        {
            "param_name": "value",
