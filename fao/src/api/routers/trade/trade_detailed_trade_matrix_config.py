...
# Generated as: fao/src/api/routers/trade_detailed_trade_matrix_config.py
...
@dataclass
class TradeDetailedTradeMatrixConfig:
    """Configuration for trade_detailed_trade_matrix API"""
    
    # Basic info
    name: str = "trade_detailed_trade_matrix"
    model_name: str = "TradeDetailedTradeMatrix"
    table_name: str = "trade_detailed_trade_matrix"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": TradeDetailedTradeMatrix.reporter_country_code_id,
        },
        {
        ...
        },
        {
            ...
            "join_condition": TradeDetailedTradeMatrix.partner_country_code_id,
        },
        {
        ...
        },
        {
            ...
            "join_condition": TradeDetailedTradeMatrix.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": TradeDetailedTradeMatrix.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": TradeDetailedTradeMatrix.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": TradeDetailedTradeMatrix,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": TradeDetailedTradeMatrix,
            "filter_column": "year",
        },
        {
            "param_name": "value",
