...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in trade_crops_livestock_indicators")
...
@router.get("/item_codes", summary="Get ItemCodes in trade_crops_livestock_indicators")
