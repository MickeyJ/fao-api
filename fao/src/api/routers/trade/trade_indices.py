...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(TradeIndices, AreaCodes.id == TradeIndices.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(TradeIndices, ItemCodes.id == TradeIndices.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(TradeIndices, Elements.id == TradeIndices.element_code_id)
