...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in trade_indices")
...
@router.get("/item_codes", summary="Get ItemCodes in trade_indices")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(TradeIndices, Elements.id == TradeIndices.element_id)
            .where(Elements.source_dataset == 'trade_indices')
            .group_by(
                Elements.element_code,
                Elements.element,
