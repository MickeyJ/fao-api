...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(TradeCropsLivestock, AreaCodes.id == TradeCropsLivestock.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(TradeCropsLivestock, ItemCodes.id == TradeCropsLivestock.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(TradeCropsLivestock, Elements.id == TradeCropsLivestock.element_code_id)
