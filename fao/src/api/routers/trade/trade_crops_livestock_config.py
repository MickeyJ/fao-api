...
# Generated as: fao/src/api/routers/trade_crops_livestock_config.py
...
@dataclass
class TradeCropsLivestockConfig:
    """Configuration for trade_crops_livestock API"""
    
    # Basic info
    name: str = "trade_crops_livestock"
    model_name: str = "TradeCropsLivestock"
    table_name: str = "trade_crops_livestock"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": TradeCropsLivestock.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": TradeCropsLivestock.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": TradeCropsLivestock.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": TradeCropsLivestock.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": TradeCropsLivestock,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": TradeCropsLivestock,
            "filter_column": "year",
        },
        {
            "param_name": "value",
