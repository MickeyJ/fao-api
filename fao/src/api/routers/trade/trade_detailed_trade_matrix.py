...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(TradeDetailedTradeMatrix, ItemCodes.id == TradeDetailedTradeMatrix.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(TradeDetailedTradeMatrix, Elements.id == TradeDetailedTradeMatrix.element_code_id)
