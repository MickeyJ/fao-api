...
# Generated as: fao/src/api/routers/trade_indices_config.py
...
@dataclass
class TradeIndicesConfig:
    """Configuration for trade_indices API"""
    
    # Basic info
    name: str = "trade_indices"
    model_name: str = "TradeIndices"
    table_name: str = "trade_indices"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": TradeIndices.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": TradeIndices.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": TradeIndices.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": TradeIndices.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": TradeIndices,  # <-- Actual model class
