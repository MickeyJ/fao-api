...
# Generated as: fao/src/api/routers/emissions_livestock_config.py
...
@dataclass
class EmissionsLivestockConfig:
    """Configuration for emissions_livestock API"""
    
    # Basic info
    name: str = "emissions_livestock"
    model_name: str = "EmissionsLivestock"
    table_name: str = "emissions_livestock"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EmissionsLivestock.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsLivestock.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsLivestock.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsLivestock.source_code_id,
        },
        {
            "name": "source",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsLivestock.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EmissionsLivestock,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EmissionsLivestock,
            "filter_column": "year",
        },
        {
            "param_name": "value",
