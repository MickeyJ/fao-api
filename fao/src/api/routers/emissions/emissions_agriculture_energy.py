...
router = APIRouter(
    ...
    tags=["emissions_agriculture_energy"],
...
def get_emissions_agriculture_energy(
    ...
    """
    emissions agriculture energy data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EmissionsAgricultureEnergy.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EmissionsAgricultureEnergy.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EmissionsAgricultureEnergy.element_code_id == Elements.id)
        .outerjoin(Flags, EmissionsAgricultureEnergy.flag_id == Flags.id)
    )
