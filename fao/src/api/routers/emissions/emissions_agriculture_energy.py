...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsAgricultureEnergy, AreaCodes.id == EmissionsAgricultureEnergy.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsAgricultureEnergy, ItemCodes.id == EmissionsAgricultureEnergy.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsAgricultureEnergy, Elements.id == EmissionsAgricultureEnergy.element_code_id)
