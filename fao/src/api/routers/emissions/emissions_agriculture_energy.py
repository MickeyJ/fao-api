...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in emissions_agriculture_energy")
...
@router.get("/item_codes", summary="Get ItemCodes in emissions_agriculture_energy")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EmissionsAgricultureEnergy, Elements.id == EmissionsAgricultureEnergy.element_id)
            .where(Elements.source_dataset == 'emissions_agriculture_energy')
            .group_by(
                Elements.element_code,
                Elements.element,
