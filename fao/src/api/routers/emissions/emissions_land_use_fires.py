...
def get_emissions_land_use_fires(
    ...
    """
    emissions land use fires data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EmissionsLandUseFires.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EmissionsLandUseFires.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EmissionsLandUseFires.element_code_id == Elements.id)
        .outerjoin(Sources, EmissionsLandUseFires.source_code_id == Sources.id)
        .outerjoin(Flags, EmissionsLandUseFires.flag_id == Flags.id)
    )
