...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsLandUseFires, AreaCodes.id == EmissionsLandUseFires.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsLandUseFires, ItemCodes.id == EmissionsLandUseFires.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsLandUseFires, Elements.id == EmissionsLandUseFires.element_code_id)
