...
router = APIRouter(
    ...
    tags=["emissions_drained_organic_soils"],
...
def get_emissions_drained_organic_soils(
    ...
    """
    emissions drained organic soils data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EmissionsDrainedOrganicSoils.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EmissionsDrainedOrganicSoils.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EmissionsDrainedOrganicSoils.element_code_id == Elements.id)
        .outerjoin(Sources, EmissionsDrainedOrganicSoils.source_code_id == Sources.id)
        .outerjoin(Flags, EmissionsDrainedOrganicSoils.flag_id == Flags.id)
    )
