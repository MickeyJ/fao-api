...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsDrainedOrganicSoils, AreaCodes.id == EmissionsDrainedOrganicSoils.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsDrainedOrganicSoils, ItemCodes.id == EmissionsDrainedOrganicSoils.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsDrainedOrganicSoils, Elements.id == EmissionsDrainedOrganicSoils.element_code_id)
