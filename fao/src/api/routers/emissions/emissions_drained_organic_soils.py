...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in emissions_drained_organic_soils")
...
@router.get("/item_codes", summary="Get ItemCodes in emissions_drained_organic_soils")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EmissionsDrainedOrganicSoils, Elements.id == EmissionsDrainedOrganicSoils.element_id)
            .where(Elements.source_dataset == 'emissions_drained_organic_soils')
            .group_by(
                Elements.element_code,
                Elements.element,
