...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in emissions_totals")
...
@router.get("/item_codes", summary="Get ItemCodes in emissions_totals")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EmissionsTotals, Elements.id == EmissionsTotals.element_id)
            .where(Elements.source_dataset == 'emissions_totals')
            .group_by(
                Elements.element_code,
                Elements.element,
