...
def get_emissions_totals(
    ...
    """
    emissions totals data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EmissionsTotals.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EmissionsTotals.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EmissionsTotals.element_code_id == Elements.id)
        .outerjoin(Sources, EmissionsTotals.source_code_id == Sources.id)
        .outerjoin(Flags, EmissionsTotals.flag_id == Flags.id)
    )
