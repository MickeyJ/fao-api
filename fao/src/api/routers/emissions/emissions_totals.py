...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsTotals, AreaCodes.id == EmissionsTotals.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsTotals, ItemCodes.id == EmissionsTotals.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsTotals, Elements.id == EmissionsTotals.element_code_id)
