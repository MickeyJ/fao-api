...
def get_emissions_livestock(
    ...
    """
    emissions livestock data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(ItemCodes, EmissionsLivestock.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EmissionsLivestock.element_code_id == Elements.id)
        .outerjoin(Sources, EmissionsLivestock.source_code_id == Sources.id)
        .outerjoin(Flags, EmissionsLivestock.flag_id == Flags.id)
    )
