...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsLivestock, AreaCodes.id == EmissionsLivestock.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsLivestock, ItemCodes.id == EmissionsLivestock.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsLivestock, Elements.id == EmissionsLivestock.element_code_id)
