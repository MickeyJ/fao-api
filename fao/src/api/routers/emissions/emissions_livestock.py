...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in emissions_livestock")
...
@router.get("/item_codes", summary="Get ItemCodes in emissions_livestock")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EmissionsLivestock, Elements.id == EmissionsLivestock.element_id)
            .where(Elements.source_dataset == 'emissions_livestock')
            .group_by(
                Elements.element_code,
                Elements.element,
