...
# Generated as: fao/src/api/routers/emissions_crops_config.py
...
@dataclass
class EmissionsCropsConfig:
    """Configuration for emissions_crops API"""
    
    # Basic info
    name: str = "emissions_crops"
    model_name: str = "EmissionsCrops"
    table_name: str = "emissions_crops"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EmissionsCrops.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsCrops.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsCrops.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsCrops.source_code_id,
        },
        {
            "name": "source",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsCrops.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EmissionsCrops,  # <-- Actual model class
