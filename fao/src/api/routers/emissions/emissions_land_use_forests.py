...
def get_emissions_land_use_forests(
    ...
    """
    emissions land use forests data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EmissionsLandUseForests.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EmissionsLandUseForests.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EmissionsLandUseForests.element_code_id == Elements.id)
        .outerjoin(Sources, EmissionsLandUseForests.source_code_id == Sources.id)
        .outerjoin(Flags, EmissionsLandUseForests.flag_id == Flags.id)
    )
