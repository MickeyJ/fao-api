...
# Generated as: fao/src/api/routers/emissions_land_use_fires_config.py
...
@dataclass
class EmissionsLandUseFiresConfig:
    """Configuration for emissions_land_use_fires API"""
    
    # Basic info
    name: str = "emissions_land_use_fires"
    model_name: str = "EmissionsLandUseFires"
    table_name: str = "emissions_land_use_fires"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EmissionsLandUseFires.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsLandUseFires.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsLandUseFires.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsLandUseFires.source_code_id,
        },
        {
            "name": "source",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsLandUseFires.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EmissionsLandUseFires,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EmissionsLandUseFires,
            "filter_column": "year",
        },
        {
            "param_name": "value",
