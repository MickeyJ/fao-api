...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsCrops, AreaCodes.id == EmissionsCrops.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsCrops, ItemCodes.id == EmissionsCrops.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsCrops, Elements.id == EmissionsCrops.element_code_id)
