...
def get_emissions_crops(
    ...
    """
    emissions crops data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EmissionsCrops.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EmissionsCrops.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EmissionsCrops.element_code_id == Elements.id)
        .outerjoin(Sources, EmissionsCrops.source_code_id == Sources.id)
        .outerjoin(Flags, EmissionsCrops.flag_id == Flags.id)
    )
