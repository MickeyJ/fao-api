...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in emissions_crops")
...
@router.get("/item_codes", summary="Get ItemCodes in emissions_crops")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EmissionsCrops, Elements.id == EmissionsCrops.element_id)
            .where(Elements.source_dataset == 'emissions_crops')
            .group_by(
                Elements.element_code,
                Elements.element,
