...
# Generated as: fao/src/api/routers/emissions_agriculture_energy_config.py
...
@dataclass
class EmissionsAgricultureEnergyConfig:
    """Configuration for emissions_agriculture_energy API"""
    
    # Basic info
    name: str = "emissions_agriculture_energy"
    model_name: str = "EmissionsAgricultureEnergy"
    table_name: str = "emissions_agriculture_energy"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EmissionsAgricultureEnergy.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsAgricultureEnergy.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsAgricultureEnergy.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsAgricultureEnergy.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EmissionsAgricultureEnergy,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EmissionsAgricultureEnergy,
            "filter_column": "year",
        },
        {
            "param_name": "value",
