...
# Generated as: fao/src/api/routers/emissions_drained_organic_soils_config.py
...
@dataclass
class EmissionsDrainedOrganicSoilsConfig:
    """Configuration for emissions_drained_organic_soils API"""
    
    # Basic info
    name: str = "emissions_drained_organic_soils"
    model_name: str = "EmissionsDrainedOrganicSoils"
    table_name: str = "emissions_drained_organic_soils"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EmissionsDrainedOrganicSoils.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsDrainedOrganicSoils.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsDrainedOrganicSoils.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsDrainedOrganicSoils.source_code_id,
        },
        {
            "name": "source",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsDrainedOrganicSoils.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EmissionsDrainedOrganicSoils,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EmissionsDrainedOrganicSoils,
            "filter_column": "year",
        },
        {
            "param_name": "value",
