...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in emissions_pre_post_production")
...
@router.get("/item_codes", summary="Get ItemCodes in emissions_pre_post_production")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(EmissionsPrePostProduction, Elements.id == EmissionsPrePostProduction.element_id)
            .where(Elements.source_dataset == 'emissions_pre_post_production')
            .group_by(
                Elements.element_code,
                Elements.element,
