...
router = APIRouter(
    ...
    tags=["emissions_pre_post_production"],
...
def get_emissions_pre_post_production(
    ...
    """
    emissions pre post production data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, EmissionsPrePostProduction.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, EmissionsPrePostProduction.item_code_id == ItemCodes.id)
        .outerjoin(Elements, EmissionsPrePostProduction.element_code_id == Elements.id)
        .outerjoin(Flags, EmissionsPrePostProduction.flag_id == Flags.id)
    )
