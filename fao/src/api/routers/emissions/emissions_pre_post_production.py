...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsPrePostProduction, AreaCodes.id == EmissionsPrePostProduction.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsPrePostProduction, ItemCodes.id == EmissionsPrePostProduction.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(EmissionsPrePostProduction, Elements.id == EmissionsPrePostProduction.element_code_id)
