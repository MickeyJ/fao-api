...
# Generated as: fao/src/api/routers/emissions_pre_post_production_config.py
...
@dataclass
class EmissionsPrePostProductionConfig:
    """Configuration for emissions_pre_post_production API"""
    
    # Basic info
    name: str = "emissions_pre_post_production"
    model_name: str = "EmissionsPrePostProduction"
    table_name: str = "emissions_pre_post_production"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EmissionsPrePostProduction.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsPrePostProduction.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsPrePostProduction.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsPrePostProduction.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EmissionsPrePostProduction,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EmissionsPrePostProduction,
            "filter_column": "year",
        },
        {
            "param_name": "value",
