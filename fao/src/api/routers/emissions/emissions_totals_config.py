...
# Generated as: fao/src/api/routers/emissions_totals_config.py
...
@dataclass
class EmissionsTotalsConfig:
    """Configuration for emissions_totals API"""
    
    # Basic info
    name: str = "emissions_totals"
    model_name: str = "EmissionsTotals"
    table_name: str = "emissions_totals"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EmissionsTotals.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsTotals.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsTotals.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsTotals.source_code_id,
        },
        {
            "name": "source",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmissionsTotals.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EmissionsTotals,  # <-- Actual model class
