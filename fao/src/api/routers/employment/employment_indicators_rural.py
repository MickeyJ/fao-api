...
def get_employment_indicators_rural(
    ...
    """
    employment indicators rural data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(Sources, EmploymentIndicatorsRural.source_code_id == Sources.id)
        .outerjoin(Indicators, EmploymentIndicatorsRural.indicator_code_id == Indicators.id)
        .outerjoin(Sexs, EmploymentIndicatorsRural.sex_code_id == Sexs.id)
        .outerjoin(Elements, EmploymentIndicatorsRural.element_code_id == Elements.id)
        .outerjoin(Flags, EmploymentIndicatorsRural.flag_id == Flags.id)
    )
