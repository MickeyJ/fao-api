...
# Generated as: fao/src/api/routers/employment_indicators_agriculture_config.py
...
@dataclass
class EmploymentIndicatorsAgricultureConfig:
    """Configuration for employment_indicators_agriculture API"""
    
    # Basic info
    name: str = "employment_indicators_agriculture"
    model_name: str = "EmploymentIndicatorsAgriculture"
    table_name: str = "employment_indicators_agriculture"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": EmploymentIndicatorsAgriculture.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmploymentIndicatorsAgriculture.source_code_id,
        },
        {
            "name": "source",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmploymentIndicatorsAgriculture.indicator_code_id,
        },
        {
            "name": "indicator",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmploymentIndicatorsAgriculture.sex_code_id,
        },
        {
            "name": "sex",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmploymentIndicatorsAgriculture.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": EmploymentIndicatorsAgriculture.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": EmploymentIndicatorsAgriculture,  # <-- Actual model class
    ...
    range_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "param_name": "year",
            "filter_model": EmploymentIndicatorsAgriculture,
            "filter_column": "year",
        },
        {
            "param_name": "value",
