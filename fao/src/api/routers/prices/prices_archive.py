...
def get_prices_archive(
    ...
    """
    prices archive data with filters.
    Filter options:
    ...
    query = (
        ...
        .outerjoin(AreaCodes, PricesArchive.area_code_id == AreaCodes.id)
        .outerjoin(ItemCodes, PricesArchive.item_code_id == ItemCodes.id)
        .outerjoin(Elements, PricesArchive.element_code_id == Elements.id)
        .outerjoin(Flags, PricesArchive.flag_id == Flags.id)
    )
