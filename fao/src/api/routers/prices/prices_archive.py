...
def get_available_areas(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(PricesArchive, AreaCodes.id == PricesArchive.area_code_id)
...
def get_available_items(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(PricesArchive, ItemCodes.id == PricesArchive.item_code_id)
...
def get_available_elements(db: Session = Depends(get_db)):
    ...
    query = (
        ...
        .join(PricesArchive, Elements.id == PricesArchive.element_code_id)
