...
# ========== Metadata Endpoints ==========
# ----------------------------------------
@router.get("/area_codes", summary="Get AreaCodes in prices_archive")
...
@router.get("/item_codes", summary="Get ItemCodes in prices_archive")
...
async def get_available_elements(
    ...
    if include_distribution:
        query = (
            ...
            .select_from(Elements)
            .join(PricesArchive, Elements.id == PricesArchive.element_id)
            .where(Elements.source_dataset == 'prices_archive')
            .group_by(
                Elements.element_code,
                Elements.element,
