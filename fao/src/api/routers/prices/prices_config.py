...
# Generated as: fao/src/api/routers/prices_config.py
...
@dataclass
class PricesConfig:
    """Configuration for prices API"""
    
    # Basic info
    name: str = "prices"
    model_name: str = "Prices"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": Prices.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Prices.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": Prices.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": Prices,  # <-- Actual model class
