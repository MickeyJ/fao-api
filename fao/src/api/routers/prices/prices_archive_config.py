...
# Generated as: fao/src/api/routers/prices_archive_config.py
...
@dataclass
class PricesArchiveConfig:
    """Configuration for prices_archive API"""
    
    # Basic info
    name: str = "prices_archive"
    model_name: str = "PricesArchive"
    table_name: str = "prices_archive"
    ...
    filter_configs: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            ...
            "join_condition": PricesArchive.area_code_id,
        },
        {
            "name": "area",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": PricesArchive.item_code_id,
        },
        {
            "name": "item",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": PricesArchive.element_code_id,
        },
        {
            "name": "element",
            "filter_type": "like",
        ...
        },
        {
            ...
            "join_condition": PricesArchive.flag_id,
        },
        {
            "name": "description",
            "filter_type": "like",
        ...
        },
        {
            "name": "year_code",
            "filter_type": "like",
            "filter_model": PricesArchive,  # <-- Actual model class
