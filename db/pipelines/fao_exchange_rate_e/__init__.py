...
# DATA_DIR = "https://food-oasis-data.s3.amazonaws.com/Exchange_rate_E_All_Data_(Normalized)"
DATA_DIR = Path(
    r"C:\Users\18057\Documents\Data\Food_FAO\Organized\Exchange_rate_E_All_Data_(Normalized)"
)
